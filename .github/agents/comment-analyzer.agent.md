...
description: Analyzes code comments for accuracy, completeness, and long-term maintainability. Use when reviewing documentation comments, docstrings, or inline comments for potential issues.
