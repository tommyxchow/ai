...
description: |
  ...
  Examples:
  - After implementing a new feature: "I've implemented authentication for the /api/users endpoint" → Use code-simplifier to refine
  - After fixing a bug with conditional checks: Launch code-simplifier to ensure the fix follows best practices
  - After performance optimization: Use code-simplifier to ensure optimized code is also clear and maintainable
mode: subagent
tools:
  read: true
  write: true
